...
app.include_router(storyboard_router, prefix=f"{settings.API_V1_STR}/storyboard", tags=["storyboard"])
app.include_router(characters_router, prefix=f"{settings.API_V1_STR}/characters", tags=["characters"])
app.include_router(images_router, prefix=f"{settings.API_V1_STR}/images", tags=["images"])
app.include_router(animations_router, prefix=f"{settings.API_V1_STR}/animations", tags=["animations"])
